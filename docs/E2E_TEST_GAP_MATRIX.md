...
Generated: 2026-03-08T12:12:19.322Z
...
- Total app routes/pages scanned: 117
- Playwright spec files scanned: 19
...
| `/admin/dashboard` | `apps/web/src/app/admin/dashboard/page.tsx` | ui | Covered | `apps/web/e2e/link-integrity.spec.ts` |
...
| `/admin/templates/:id` | `apps/web/src/app/admin/templates/[id]/page.tsx` | ui | Covered | `apps/web/e2e/gap-matrix-coverage.spec.ts` |
...
| `/admin/templates/new` | `apps/web/src/app/admin/templates/new/page.tsx` | ui | Covered | `apps/web/e2e/gap-matrix-coverage.spec.ts` |
...
| `/api/test/clear-rate-limit` | `apps/web/src/app/api/test/clear-rate-limit/route.ts` | api | Covered | `apps/web/e2e/escalation-approval.spec.ts`, `apps/web/e2e/public-signin.spec.ts`, `apps/web/e2e/visual-regression.spec.ts` |
...
| `/s/:slug` | `apps/web/src/app/s/[slug]/page.tsx` | ui | Covered | `apps/web/e2e/a11y.spec.ts`, `apps/web/e2e/escalation-approval.spec.ts`, `apps/web/e2e/kiosk-mode.spec.ts`, `apps/web/e2e/link-integrity.spec.ts`, `apps/web/e2e/logic-flow.spec.ts`, `apps/web/e2e/public-signin.spec.ts`, `apps/web/e2e/visual-regression.spec.ts` |
