...
Generated: 2026-03-24T07:54:14.336Z
...
- Total app routes/pages scanned: 122
- Playwright spec files scanned: 20
- Distinct referenced paths found: 125
- Static referenced paths: 125
- Dynamic referenced paths: 0
- JS-flow mode enabled: no
- Anchor-crawl discovered paths: 0
- JS-flow discovered paths: 0
- Covered routes/pages: 120
- Gaps: 2
- UI coverage: 75/76
- API coverage: 45/46
- Dynamic mode enabled: no
...
| `/admin/actions` | `apps/web/src/app/admin/actions/page.tsx` | ui | Covered | `apps/web/e2e/gap-matrix-coverage.spec.ts` |
...
| `/admin/audit-log` | `apps/web/src/app/admin/audit-log/page.tsx` | ui | Covered | `apps/web/e2e/link-integrity.spec.ts` |
...
| `/admin/competency` | `apps/web/src/app/admin/competency/page.tsx` | ui | Covered | `apps/web/e2e/gap-matrix-coverage.spec.ts` |
| `/admin/contractors` | `apps/web/src/app/admin/contractors/page.tsx` | ui | Covered | `apps/web/e2e/admin-management.spec.ts` |
| `/admin/contractors/:id` | `apps/web/src/app/admin/contractors/[id]/page.tsx` | ui | Covered | `apps/web/e2e/admin-auth.spec.ts`, `apps/web/e2e/admin-management.spec.ts` |
| `/admin/contractors/new` | `apps/web/src/app/admin/contractors/new/page.tsx` | ui | Covered | `apps/web/e2e/admin-auth.spec.ts`, `apps/web/e2e/admin-management.spec.ts` |
| `/admin/dashboard` | `apps/web/src/app/admin/dashboard/page.tsx` | ui | Covered | `apps/web/e2e/a11y.spec.ts`, `apps/web/e2e/admin-auth.spec.ts`, `apps/web/e2e/link-integrity.spec.ts` |
...
| `/admin/exports` | `apps/web/src/app/admin/exports/page.tsx` | ui | Covered | `apps/web/e2e/export.spec.ts`, `apps/web/e2e/link-integrity.spec.ts` |
| `/admin/hazards` | `apps/web/src/app/admin/hazards/page.tsx` | ui | Covered | `apps/web/e2e/admin-hazards.spec.ts` |
| `/admin/history` | `apps/web/src/app/admin/history/page.tsx` | ui | Covered | `apps/web/e2e/link-integrity.spec.ts` |
| `/admin/incidents` | `apps/web/src/app/admin/incidents/page.tsx` | ui | Covered | `apps/web/e2e/gap-matrix-coverage.spec.ts` |
| `/admin/inspections` | `apps/web/src/app/admin/inspections/page.tsx` | ui | Covered | `apps/web/e2e/gap-matrix-coverage.spec.ts` |
| `/admin/integrations/channels` | `apps/web/src/app/admin/integrations/channels/page.tsx` | ui | Covered | `apps/web/e2e/admin-auth.spec.ts`, `apps/web/e2e/gap-matrix-coverage.spec.ts` |
| `/admin/integrations/procore` | `apps/web/src/app/admin/integrations/procore/page.tsx` | ui | Covered | `apps/web/e2e/admin-auth.spec.ts`, `apps/web/e2e/gap-matrix-coverage.spec.ts` |
| `/admin/live-register` | `apps/web/src/app/admin/live-register/page.tsx` | ui | Covered | `apps/web/e2e/admin-auth.spec.ts`, `apps/web/e2e/link-integrity.spec.ts`, `apps/web/e2e/visual-regression.spec.ts` |
| `/admin/mobile` | `apps/web/src/app/admin/mobile/page.tsx` | ui | Covered | `apps/web/e2e/gap-matrix-coverage.spec.ts` |
| `/admin/mobile/native` | `apps/web/src/app/admin/mobile/native/page.tsx` | ui | Covered | `apps/web/e2e/admin-auth.spec.ts`, `apps/web/e2e/gap-matrix-coverage.spec.ts` |
...
| `/admin/plan-configurator` | `apps/web/src/app/admin/plan-configurator/page.tsx` | ui | Covered | `apps/web/e2e/gap-matrix-coverage.spec.ts` |
| `/admin/policy-simulator` | `apps/web/src/app/admin/policy-simulator/page.tsx` | ui | Covered | `apps/web/e2e/gap-matrix-coverage.spec.ts` |
| `/admin/pre-registrations` | `apps/web/src/app/admin/pre-registrations/page.tsx` | ui | Covered | `apps/web/e2e/gap-matrix-coverage.spec.ts` |
...
| `/admin/risk-passport` | `apps/web/src/app/admin/risk-passport/page.tsx` | ui | Covered | `apps/web/e2e/gap-matrix-coverage.spec.ts` |
...
| `/admin/settings` | `apps/web/src/app/admin/settings/page.tsx` | ui | Covered | `apps/web/e2e/admin-settings.spec.ts` |
| `/admin/sites` | `apps/web/src/app/admin/sites/page.tsx` | ui | Covered | `apps/web/e2e/admin-emergency-contacts.spec.ts`, `apps/web/e2e/admin-hazards.spec.ts`, `apps/web/e2e/link-integrity.spec.ts`, `apps/web/e2e/visual-regression.spec.ts` |
| `/admin/sites/:id` | `apps/web/src/app/admin/sites/[id]/page.tsx` | ui | Covered | `apps/web/e2e/admin-emergency-contacts.spec.ts`, `apps/web/e2e/admin-hazards.spec.ts`, `apps/web/e2e/gap-matrix-coverage.spec.ts` |
...
| `/admin/sites/new` | `apps/web/src/app/admin/sites/new/page.tsx` | ui | Covered | `apps/web/e2e/admin-emergency-contacts.spec.ts`, `apps/web/e2e/admin-hazards.spec.ts` |
| `/admin/templates` | `apps/web/src/app/admin/templates/page.tsx` | ui | Covered | `apps/web/e2e/link-integrity.spec.ts` |
| `/admin/templates/:id` | `apps/web/src/app/admin/templates/[id]/page.tsx` | ui | Covered | `apps/web/e2e/admin-auth.spec.ts`, `apps/web/e2e/gap-matrix-coverage.spec.ts` |
...
| `/admin/templates/new` | `apps/web/src/app/admin/templates/new/page.tsx` | ui | Covered | `apps/web/e2e/admin-auth.spec.ts`, `apps/web/e2e/gap-matrix-coverage.spec.ts` |
| `/admin/trust-graph` | `apps/web/src/app/admin/trust-graph/page.tsx` | ui | Covered | `apps/web/e2e/gap-matrix-coverage.spec.ts` |
| `/admin/users` | `apps/web/src/app/admin/users/page.tsx` | ui | Covered | `apps/web/e2e/admin-management.spec.ts` |
| `/admin/users/:id` | `apps/web/src/app/admin/users/[id]/page.tsx` | ui | Covered | `apps/web/e2e/gap-matrix-coverage.spec.ts` |
| `/admin/users/new` | `apps/web/src/app/admin/users/new/page.tsx` | ui | Covered | `apps/web/e2e/gap-matrix-coverage.spec.ts` |
...
| `/login` | `apps/web/src/app/(auth)/login/page.tsx` | ui | Covered | `apps/web/e2e/admin-auth.spec.ts`, `apps/web/e2e/link-integrity.spec.ts`, `apps/web/e2e/visual-regression.spec.ts` |
