...
1. **Quality bar: tenant isolation, auth, auditability, data safety, operability, release safety**
   - Evidence:
     ...
     - CSP middleware: [apps/web/src/middleware.ts](apps/web/src/middleware.ts#L45-L171)
     - Production checklist: [PRODUCTION_CHECKLIST.md](PRODUCTION_CHECKLIST.md)
     - Threat model: [docs/THREAT_MODEL.md](docs/THREAT_MODEL.md)
     - SLOs: [docs/SLO.md](docs/SLO.md)
     - Incident runbook: [docs/RUNBOOK_INCIDENT.md](docs/RUNBOOK_INCIDENT.md)
     - Status: Complete
...
2. **Concrete artifacts: guardrails, threat model, production checklist, SLOs, runbooks**
   - Evidence:
     ...
     - Threat model: [docs/THREAT_MODEL.md](docs/THREAT_MODEL.md)
     - SLOs: [docs/SLO.md](docs/SLO.md)
     - Runbooks: [docs/RUNBOOK_RESTORE.md](docs/RUNBOOK_RESTORE.md), [docs/RUNBOOK_ROLLBACK.md](docs/RUNBOOK_ROLLBACK.md), [docs/RUNBOOK_KEY_ROTATION.md](docs/RUNBOOK_KEY_ROTATION.md), [docs/RUNBOOK_INCIDENT.md](docs/RUNBOOK_INCIDENT.md)
   - Status: Complete
...
7. **Auth patterns + CSRF**
   ...
   - Status: Complete
   - Actions:
     - Session rotation strategy documented in [docs/SESSION_ROTATION.md](docs/SESSION_ROTATION.md).
...
9. **Security baseline: tenant data access tests, rate limiting, headers, secrets**
   - Evidence:
     ...
     - CSP headers: [apps/web/src/middleware.ts](apps/web/src/middleware.ts#L45-L171)
     - Dependency scanning: [.github/workflows/codeql.yml](.github/workflows/codeql.yml#L1-L60)
   - Status: Complete
   - Actions:
     - Secrets guidance: [docs/SECRETS_MANAGEMENT.md](docs/SECRETS_MANAGEMENT.md)
...
16. **Preview/staging/prod and release gates**
    - Evidence:
      ...
      - CI/CD plan: [docs/CI_CD_PLAN.md](docs/CI_CD_PLAN.md)
    - Status: Complete
...
17. **Backups, restore drills, incidents**
    - Evidence:
      ...
      - Restore runbook: [docs/RUNBOOK_RESTORE.md](docs/RUNBOOK_RESTORE.md)
      - Restore drill: [docs/RUNBOOK_RESTORE_DRILL.md](docs/RUNBOOK_RESTORE_DRILL.md)
      - Incident response: [docs/RUNBOOK_INCIDENT.md](docs/RUNBOOK_INCIDENT.md)
    - Status: Complete
...
18. **Ongoing routines, upgrade strategy**
    - Evidence:
      - Maintenance plan: [docs/MAINTENANCE_AND_UPGRADES.md](docs/MAINTENANCE_AND_UPGRADES.md)
      - Upgrade path: [docs/UPGRADE_PATH.md](docs/UPGRADE_PATH.md)
    - Status: Complete
...
20. **Compute split: web + worker**
    - Evidence:
      ...
      - Deployment layout: [docs/DEPLOYMENT_RENDER_NEON_R2_UPSTASH.md](docs/DEPLOYMENT_RENDER_NEON_R2_UPSTASH.md)
    - Status: Complete
...
30. **Low‑ops stack choice**
    - Evidence:
      - Deployment doc: [docs/DEPLOYMENT_RENDER_NEON_R2_UPSTASH.md](docs/DEPLOYMENT_RENDER_NEON_R2_UPSTASH.md)
    - Status: Complete
...
48. **Production docs**
    - Evidence:
      ...
      - Threat model: [docs/THREAT_MODEL.md](docs/THREAT_MODEL.md)
      - Runbooks: [docs/RUNBOOK_RESTORE.md](docs/RUNBOOK_RESTORE.md), [docs/RUNBOOK_ROLLBACK.md](docs/RUNBOOK_ROLLBACK.md)
    - Status: Complete
