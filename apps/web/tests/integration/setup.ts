...
export async function cleanDatabase(
  ...
  await prisma.$transaction([
    ...
    prisma.pendingSignInEscalation.deleteMany(),
    ...
    prisma.hazardRegisterEntry.deleteMany(),
    prisma.siteEmergencyProcedure.deleteMany(),
    prisma.siteEmergencyContact.deleteMany(),
    prisma.emergencyDrill.deleteMany(),
